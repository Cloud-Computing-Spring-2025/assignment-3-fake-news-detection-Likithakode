...
predictions = spark.read.csv("/workspaces/assignment-3-fake-news-detection-Likithakode/Task4/task4_output/part-00000-1bb8797d-f355-45c4-bc3f-a8bd5ff4e408-c000.csv", header=True, inferSchema=True)
