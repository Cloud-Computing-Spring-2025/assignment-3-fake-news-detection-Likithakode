...
df = spark.read.csv("/workspaces/assignment-3-fake-news-detection-Likithakode/Task1/task1_output.csv/part-00000-2519d8a7-9525-4e73-97b7-5de3ef303595-c000.csv", header=True, inferSchema=True)
