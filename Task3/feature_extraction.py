...
df = spark.read.csv("/workspaces/assignment-3-fake-news-detection-Likithakode/Task2/task2_output/part-00000-846287ca-a47f-4c40-a268-99cb671ff083-c000.csv", header=True, inferSchema=True)
